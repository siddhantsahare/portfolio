...
import { close, logo, selfImage, menu, selfImageCropped } from "../assets";
import {
  navLinks,
  navigationPaths,
  personalInfo,
  ...
  return (
    ...
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        >
          {/* Logo with a slight scale effect on hover */}
          <img
            src={selfImageCropped}
            alt="self Image"
          ...
          <p className="text-white text-[18px] font-semibold cursor-pointer flex">
            <span className="bg-gradient-to-r from-electric-purple to-blue-500 text-transparent bg-clip-text">
              {personalInfo.fullName}
            </span>
            &nbsp;
            <span className="lg:block hidden text-gray-300">
              | {personalInfo.role}
            </span>
          </p>
        </Link>
